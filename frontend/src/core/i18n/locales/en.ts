...
export const en: Record<string, string> = {
  ...
  "rm.search": "Search {label}...",
  "rm.noPackThumb": "No pack.png",
  "rm.packFormat": "pack_format: {format}",
  "rm.status": "Status",
  "rm.enabled": "✅ Enabled",
  "rm.disabled": "⛔ Disabled",
  "rm.deleteLabel": "Delete this {label}",
  "rm.selectToView": "Select a {label} to view details",
  "rm.unknownType": "Unknown resource type: {type}",
  "rm.notSetPath": "{label} path not set",
  "rm.configureDirFirst": "Please configure the {label} directory in Settings first",
  "rm.emptyType": "No {label} yet",
  "rm.searching": "Searching...",
  "rm.deleted": "Deleted",
