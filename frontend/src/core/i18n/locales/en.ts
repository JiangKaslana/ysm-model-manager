...
export const en: Record<string, string> = {
  ...
  "diagnostics.healthTitle": "Repo Health",
  "diagnostics.healthHint": "One-shot check: completeness, cache, resources, dedup (same source as CLI health-report)",
  ...
  "preview.switchDirTab": "Current Directory",
