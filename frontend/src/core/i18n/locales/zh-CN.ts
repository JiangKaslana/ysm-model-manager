...
export const zhCN: Record<string, string> = {
  ...
  "diagnostics.healthTitle": "仓库体检",
  "diagnostics.healthHint": "一键体检：完整性、缓存、资源、去重（与 CLI health-report 同源）",
