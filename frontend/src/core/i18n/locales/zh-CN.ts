...
export const zhCN: Record<string, string> = {
  ...
  "rm.search": "搜索{label}...",
  "rm.noPackThumb": "无pack.png",
  "rm.packFormat": "pack_format: {format}",
  "rm.status": "状态",
  "rm.enabled": "✅ 启用",
  "rm.disabled": "⛔ 禁用",
  "rm.deleteLabel": "删除此{label}",
  "rm.selectToView": "请选择一个{label}查看详情",
  "rm.unknownType": "未知资源类型: {type}",
  "rm.notSetPath": "未设置{label}路径",
  "rm.configureDirFirst": "请先在设置页配置{label}目录",
  "rm.emptyType": "暂无{label}",
  "rm.searching": "搜索中...",
  "rm.deleted": "已删除",
  "rtype.pack": "资源包",
  "rtype.shader": "光影包",
