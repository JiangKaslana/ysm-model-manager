...
export const ja: Record<string, string> = {
  ...
  "diagnostics.perfModelPlaceholder": "ysm.json パスを入力（例: ./model/player.ysm）",
  "diagnostics.perfModelRequired": "モデルのパスを入力してください",
  "diagnostics.perfIterations": "イテレーション数",
  "diagnostics.perfRunGui": "フルフロー点検(gui-flow)",
  ...
  "diagnostics.assetsBones": "ボーン",
  "diagnostics.assetsMats": "マテリアル",
  "diagnostics.assetsTex": "テクスチャ",
  "diagnostics.assetsMorphs": "Morph",
  "diagnostics.assetsAnims": "アニメーション",
  ...
  "rm.search": "{label}を検索...",
  "rm.noPackThumb": "pack.png なし",
  "rm.packFormat": "pack_format: {format}",
  "rm.status": "ステータス",
  "rm.enabled": "✅ 有効",
  "rm.disabled": "⛔ 無効",
  "rm.deleteLabel": "この{label}を削除",
  "rm.selectToView": "{label}を選択して詳細を表示",
  "rm.unknownType": "不明なリソース種別: {type}",
  "rm.notSetPath": "{label} パスが未設定です",
  "rm.configureDirFirst": "設定ページで{label}ディレクトリを先に設定してください",
  "rm.emptyType": "{label}はまだありません",
  "rm.searching": "検索中...",
  "rm.deleted": "削除しました",
  "rtype.pack": "リソースパック",
  ...
  "diagnostics.healthTitle": "リポジトリ健康診断",
  "diagnostics.healthHint": "一括チェック：完全性・キャッシュ・リソース・重複（CLI health-report と同一ソース）",
  ...
  "preview.skeletonLabel": "骨格 (Bones)",
