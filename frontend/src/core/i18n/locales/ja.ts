...
export const ja: Record<string, string> = {
  ...
  "preview.environmentDesc": "環境マップ：プロシージャルな空/スタジオ等のプリセット",
  ...
  "preview.shadowDesc": "影：光源の投射と地面の受影",
  "preview.reflector": "反射地面",
  "preview.reflectorDesc": "反射地面：環境の鏡面反射",
  "preview.reflectorOpacity": "反射の不透明度",
  "preview.reflectorResolution": "反射解像度",
  "preview.reflectorSize": "反射地面サイズ",
  "preview.ground": "地面",
