...
export const ja: Record<string, string> = {
  ...
  // ── YSM Hub ──
  "hub.searchPlaceholder": "モデルのタイトルや説明を検索",
  "hub.sortLabel": "並び順",
  "hub.sortNewest": "新着順",
  "hub.sortUpdated": "更新順",
  "hub.sortDownloaded": "ダウンロード順",
  "hub.sortLiked": "人気順",
  "hub.loadMore": "さらに読み込む",
  "hub.loading": "モデルを読み込み中…",
  "hub.loadingDetail": "モデル詳細を読み込み中…",
  "hub.noCover": "カバーなし",
  "hub.noDescription": "説明なし",
  "hub.noModels": "モデルが見つかりません",
  "hub.loadFailed": "YSM Hub の読み込みに失敗しました：{error}",
  "hub.detailFailed": "YSM Hub の詳細読み込みに失敗しました：{error}",
  "hub.unnamedVersion": "無名のバージョン",
  "hub.recommended": "おすすめ",
  "hub.download": "ローカルにダウンロード",
  ...
  "hub.repoNotConfigured": "先に YSM のローカルリポジトリを設定してください",
  "hub.downloaded": "ダウンロード先：{path}",
  "hub.downloadFailed": "ダウンロードに失敗しました：{error}",
  "hub.login": "ログイン",
  "hub.authorizing": "ブラウザで認証中…",
  "hub.loginSuccess": "YSM Hub にログインしました",
  "hub.loginFailed": "YSM Hub のログインに失敗しました：{error}",
