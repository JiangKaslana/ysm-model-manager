// utils/core/path.ts — 零依赖叶：纯路径工具。
// 禁止从本文件 import 任何应用层模块。
// 下沉自 MikuMikuAR @/core/utils 去桶化（ADR-191）：纯模块从桶导入会拖起整套应用层，
// 致 vitest fork worker 留 pending 微任务、测试 EXIT=124。
