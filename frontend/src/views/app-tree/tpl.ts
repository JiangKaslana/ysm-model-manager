...
<div class="hdr-row hdr-btn-row">
  ...
  <div class="dd-wrap" id="dd-more"><button class="btn-base sm" id="btn-more" data-testid="tree-more">${t("tree.more")}</button><div class="dd-menu" id="menu-more"><button class="dd-item" data-more="import-file" data-testid="tree-more-import-file"> ${t("tree.moreImportFile")}</button><button class="dd-item" data-more="import-dir" data-testid="tree-more-import-dir">${t("tree.moreImportDir")}</button><button class="dd-item" data-more="sel-all" id="sel-all" data-testid="tree-sel-all">${t("tree.moreSelectAll")}</button><button class="dd-item" data-more="repo-export" id="repo-export" data-testid="tree-repo-export"> ${t("tree.moreBoneStruct")}</button><div style="border-top:1px solid var(--bd);margin:2px 0"></div><button class="dd-item" data-more="open-folder" data-testid="tree-more-open-folder">${t("tree.moreOpenFolder")}</button><button class="dd-item" data-more="refresh" data-testid="tree-more-refresh">${t("tree.moreRefresh")}</button><button class="dd-item" data-more="genindex" data-testid="tree-more-genindex">${t("tree.moreGenIndex")}</button></div></div>
