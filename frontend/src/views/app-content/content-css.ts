...
.heatmap-bar { width:100%; border-radius:var(--radius-xs); min-height:4px; transition:all .2s; }
...
.cr-preset-btn { font-size:var(--fs-sm);padding:3px 10px;border-radius:var(--radius-md);border:1px solid var(--bd);background:transparent;color:var(--muted);cursor:pointer;font-family:inherit;transition:var(--tr-fast);animation:fadeSlideUp var(--tr-enter) both; }
...
.ws-open-btn, .cr-open-btn { padding:4px 10px;border-radius:var(--radius-sm);border:1px solid var(--bd);background:transparent;color:var(--accent);cursor:pointer;font-size:var(--fs-sm);font-family:inherit; }
