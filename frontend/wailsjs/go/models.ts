...
export namespace types {
	...
	export class AppConfig {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.mmdRoot = source["mmdRoot"];
	        this.vrcRoot = source["vrcRoot"];
	        this.mcRoot = source["mcRoot"];
	        this.linkMode = source["linkMode"];
	        this.theme = source["theme"];
	        this.mirror = source["mirror"];
	        this.mirrorCustomBase = source["mirrorCustomBase"];
	        this.mirrorCustomUrl = source["mirrorCustomUrl"];
	...
	export class BedrockModelVariant {
	    name?: string;
	    identifier?: string;
	    source?: string;
	    texIndex?: number;
	    ...
	    static createFrom(source: any = {}) {
	        return new BedrockModelVariant(source);
	    }
	...
	export class BedrockModel {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.texHeight = source["texHeight"];
	        this.bones = this.convertValues(source["bones"], Bone2D);
	        this.variants = this.convertValues(source["variants"], BedrockModelVariant);
