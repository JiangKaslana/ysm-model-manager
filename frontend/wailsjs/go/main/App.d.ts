...
export function BuildModel3DSpecFromModel(arg1:types.BedrockModel):Promise<string>;
...
export function GetModel3DSpecVariant(arg1:string,arg2:number):Promise<string>;
...
export function ListOpenYsmFunctionFiles(arg1:string):Promise<Array<string>>;
...
export function SetDownloadMirrorConfig(arg1:string,arg2:string,arg3:string):Promise<void>;
