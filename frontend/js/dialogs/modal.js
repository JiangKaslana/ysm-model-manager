...
export function modalPrompt(opts) {
  return new Promise((resolve) => {
    ...
    box.innerHTML = `
      ...
      <input id="mp-input" class="dlg-input-bg" maxlength="255" value="${esc(value || "")}" placeholder="${esc(placeholder || "")}" style="width:100%;box-sizing:border-box">
...
export function modalSelect(opts) {
  return new Promise((resolve) => {
    ...
    box.innerHTML =
      ...
      esc(title) +
      "</div>" +
      '<select id="ms-select" class="dlg-input-bg" style="width:100%">' +
      (items || [])
        .map(
          (item) =>
