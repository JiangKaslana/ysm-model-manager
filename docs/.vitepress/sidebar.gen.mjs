...
export const autoSidebar = [
  ...
  },
  {
    ...
    "items": [
      ...
      {
        "text": "ADR-104：资源类型子类层（subtypes）统一：大类/小类/防御性检验三层架构",
        "link": "/adr/ADR-104-resource-subtype-layer"
      },
      {
      ...
      {
        "text": "ADR-051：错误分类单一事实来源：结构化错误码替代双份文本匹配表",
        "link": "/adr/ADR-051-error-classification-single-source"
      },
      {
        "text": "ADR-050：模型广场 · 浏览器窗口（Wails 第二窗口）",
        "link": "/adr/ADR-050-plaza-browser-window"
      },
      {
        "text": "ADR-049：网页版（Web 端）桥接：backend 适配器 + IndexedDB 模型库",
        "link": "/adr/ADR-049-web-edition-bridge"
      },
      {
        "text": "ADR-048：CI 工作流架构：双 workflow 拆分 + 可复用测试门禁 + 三层缓存 + 版本单点",
        "link": "/adr/ADR-048-ci-workflow-split-cache"
      },
      {
    ...
    "items": [
      ...
      },
      {
        ...
        "items": [
          ...
          {
            "text": "第 09 区域 · 第 4 章 · 没人应答的旧口令",
            "link": "/novel/09-工具链/04-没人应答的旧口令"
          }
        ]
      },
      {
