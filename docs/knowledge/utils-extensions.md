...
- `RESOURCE_EXTS: Record<string, string[]>` — 7 类映射：ysm(.ysm/.zip/.7z/.json)、mmd-skin(.pmx/.pmd)、vrchat-avatar(.vrca/.vrm)、resourcepack(.zip)、shaderpack(.zip)、blueprint(.nbt/.schematic)、litematic(.litematic)
