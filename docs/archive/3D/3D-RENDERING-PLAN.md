...
2. frontend/src/utils/3d/model3d-spec.ts 全文
3. frontend/src/utils/3d/model2d.ts 全文
...
3. frontend/src/utils/3d/model3d.ts
4. frontend/src/utils/3d/model2d.ts
...
| DeepSeek V4 Flash | JS 兜底 `model3d-spec.js` 同步 | `frontend/src/utils/3d/model3d-spec.ts` |
| Qwen3.7 Plus | 2D 骨骼图修正 | `frontend/src/utils/3d/model2d.ts` |
...
| `frontend/src/utils/3d/model3d-spec.ts` | `buildSpecFromModel()` :8 | JS 兜底，必须与 Go 一致 |
| `frontend/src/utils/3d/model2d.ts` | `renderModel2D()` :15 | 2D 正交投影 |
| `frontend/src/utils/3d/model2d.ts` | `rot()` :64 | Y 轴旋转函数 |
| `frontend/src/utils/3d/model3d.ts` | `renderModel3D()` :36 | Three.js 场景构建 |
