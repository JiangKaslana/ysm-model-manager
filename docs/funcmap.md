...
| `CleanupOldVersion()` | `go/updater/updater:357` | CleanupOldVersion 启动时清理上一次更新留下的 .old 文件 |
| `InstallUpdate()` | `go/updater/updater:380` | InstallUpdate 解压更新包并通过 helper 进程替换当前 exe。 |
