...
| `Mount3DOptions()` | `frontend/src/views/app-preview/mount-preview-core:174` | mount3D 附加选项（ADR-066 §5.6 3D 内模型切换） |
| `mount3D()` | `frontend/src/views/app-preview/mount-preview-core:179` | — |
