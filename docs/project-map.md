...
| `test-utils/` | 测试工具（G-1 抗脆弱测试基础设施 — ADR-035 §19.1：getByTestId / getAllByTestId / waitFor） 〔源码 6: events.ts idb-mock.ts index.ts query-by-testid.ts render.ts self-healing.ts · 测试 4〕 |
