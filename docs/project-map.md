...
| `cli/` | CLI 命令（脱离 GUI 的模型管理/诊断/缓存操作，入口 main.go 经 cli.RunCLI 接线） 〔源码 12: cache.go cli.go concurrent.go config.go flow.go json.go mmd.go model.go perf.go registry.go share… · 测试 1〕 |
